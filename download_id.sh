...
show_help(){
  ...
  echo "  -fas, --fasta   Download fasta file output"
  echo "  -json, --json   Download json file output"
  echo "  -gff, --gff   Download gff file output"
  echo "  -tsv, --tsv   Download tsv file output"
  echo
  echo "🎃 ARGUMENTS:"
